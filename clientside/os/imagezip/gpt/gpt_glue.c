...
struct gptmap gptmap[] = {
	...
	{GPT_ENT_TYPE_FREEBSD_BOOT, "FREEBSD_BOOT", IZTYPE_UNKNOWN},
	{GPT_ENT_TYPE_FREEBSD_NANDFS, "FREEBSD_NANDFS", IZTYPE_UNKNOWN},
	{GPT_ENT_TYPE_FREEBSD_SWAP, "FREEBSD_SWAP", IZTYPE_UNKNOWN},
	...
	{GPT_ENT_TYPE_BIOS_BOOT, "BIOS_BOOT", IZTYPE_UNKNOWN}
};
