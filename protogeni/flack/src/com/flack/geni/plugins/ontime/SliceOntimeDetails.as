package com.flack.geni.plugins.ontime
{
	...
	public final class SliceOntimeDetails
	{
		...
		public function SliceOntimeDetails(useSlice:Slice, useApiVersion:Number, isCreating:Boolean = true, shouldUseVirtualMCs:Boolean = false)
		{
			slice = useSlice;
